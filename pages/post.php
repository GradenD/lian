    ...
    <div class="post-container">
        <div class="single-post-head">
            ...
            <div class="post-info">
                ...
                <div class="like">
                    <p><i class="far fa-heart" aria-hidden="true"></i> 324 likes</p>
                </div>
            </div>
        </div>
        <div class="single-post-body">
            <img src="img/single-post/post-1.jpg">
            <div class="post-body-text">
                <p>
                    Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed 
                    diam nonummy nibh euismod tincidunt ut laoreet dolore magna 
                    aliquam erat volutpat. Ut wisi enim ad minim veniam, quis nostrud 
                    exerci tation ullamcorper suscipit. Ut wisi enim ad minim veniam, 
            ...
            <div class="post-body-block">
                <p>
                    ...
                    vitae dicta sunt. Lorem ipsum dolor sit amet, consectetuer adipiscing 
                ...
                <div class="coment">
                    <div class="form-group">
				        <div class="input-group">
						    ...
						    <input type="text" required class="form-control" name="username" id="username" placeholder="Name">
					    </div>
                    </div>
                    <div class="form-group">
					    <div class="input-group">
                    ...
                    <div class="form-group message-but">
					    <div class="input-group">
						    <textarea class="form-control textarea-contact" rows="5" id="comment" name="FB" placeholder="Message..." required=""></textarea>
					    </div>
